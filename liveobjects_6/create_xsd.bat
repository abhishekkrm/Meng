...
rem | SUCH DAMAGE.
rem | 
"C:\Program Files\Microsoft Visual Studio 8\SDK\v2.0\Bin\xsd.exe" C:\krzys\work\QuickSilver\QuickSilver\QuickSilver_1\bin\Debug\QuickSilver_1.dll /o:C:\krzys\work\QuickSilver\QuickSilver\QuickSilver_1 /t:QS.Fx.Endpoints.EndpointType
