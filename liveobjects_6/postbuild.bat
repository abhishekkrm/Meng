...
rem xcopy /f /y /r /e %2\..\Content\*.* C:\liveobjects\
rem rmdir /s /q C:\liveobjects\Debug
rem rmdir /s /q C:\liveobjects\Release
rem rmdir /s /q C:\liveobjects\Distribution
rem rmdir /s /q C:\liveobjects\Simulation
rem rmdir /s /q C:\liveobjects\x64
rem del /f C:\liveobjects\*.vcproj
rem del /f C:\liveobjects\*.vspscc
rem del /f C:\liveobjects\*.user