...
rem | 
echo prebuild
rem if exist C:\liveobjects\examples rmdir /s /q C:\liveobjects\examples
rem if exist C:\liveobjects\registry rmdir /s /q C:\liveobjects\registry
rem if exist C:\liveobjects\content rmdir /s /q C:\liveobjects\content
rem if exist C:\liveobjects\channels rmdir /s /q C:\liveobjects\channels
rem if exist C:\liveobjects\services rmdir /s /q C:\liveobjects\services
