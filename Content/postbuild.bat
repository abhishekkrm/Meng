...
if exist C:\liveobjects\examples rmdir /s /q C:\liveobjects\examples
if exist C:\liveobjects\registry rmdir /s /q C:\liveobjects\registry
rem | if exist C:\liveobjects\content rmdir /s /q C:\liveobjects\content
if exist C:\liveobjects\channels rmdir /s /q C:\liveobjects\channels
if exist C:\liveobjects\services rmdir /s /q C:\liveobjects\services
rem | if exist C:\liveobjects\libraries rmdir /s /q C:\liveobjects\libraries

@echo deploying examples from %2\..\Content

xcopy /f /y /r /e  %2\..\Content\channels\*.* C:\liveobjects\channels\
xcopy /f /y /r /e  %2\..\Content\examples\*.* C:\liveobjects\examples\
xcopy /f /y /r /e  %2\..\Content\registry\*.* C:\liveobjects\registry\
xcopy /f /y /r /e  %2\..\Content\services\*.* C:\liveobjects\services\
xcopy /f /y /r /e  %2\..\Content\content\*.* C:\liveobjects\content\
